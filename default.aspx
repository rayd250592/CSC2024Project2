		...
		<h1 style="margin-left:10px; font-size:x-large;" > Home </h1>
            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1">
                <AlternatingItemTemplate>
                    ...
                    <br />
                    category: <asp:HyperLink ID="HyperLink2" runat="server"
                            NavigateUrl='<%# Eval("category") + ".aspx?category=" + Eval("category")%>' >
                        
                        <asp:Label ID="categoryLabel" runat="server" Text='<%# Eval("category") %>' />

                               </asp:HyperLink><br />datetime: <asp:Label ID="datetimeLabel" runat="server" Text='<%# Eval("datetime") %>' />
                    <br />
                    isapproved: <asp:Label ID="isapprovedLabel" runat="server" Text='<%# Eval("isapproved") %>' />
                    <br />
                           
<br /></span>
                </AlternatingItemTemplate>
                <EditItemTemplate>
                    <span style="">article_id: <asp:TextBox ID="article_idTextBox" runat="server" Text='<%# Bind("article_id") %>' />
                    <br />
                    ...
                    <br />
                    category: <asp:TextBox ID="categoryTextBox" runat="server" Text='<%# Bind("category") %>' />
                    <br />
                    datetime: <asp:TextBox ID="datetimeTextBox" runat="server" Text='<%# Bind("datetime") %>' />
                    <br />
                    isapproved: <asp:TextBox ID="isapprovedTextBox" runat="server" Text='<%# Bind("isapproved") %>' />
                    <br />
                ...
                <EmptyDataTemplate>
                    ...
                    <br />category: <asp:TextBox ID="categoryTextBox" runat="server" Text='<%# Bind("category") %>' />
                    <br />datetime: <asp:TextBox ID="datetimeTextBox" runat="server" Text='<%# Bind("datetime") %>' />
                    <br />isapproved: <asp:TextBox ID="isapprovedTextBox" runat="server" Text='<%# Bind("isapproved") %>' />
                    <br />
                ...
                <ItemTemplate>
                    <span style="">article_id: <asp:Label ID="article_idLabel" runat="server" Text='<%# Eval("article_id") %>' />
                    <br />
...
<br /></span>
                ...
                <SelectedItemTemplate>
                    ...
                    <br />
                    category: <asp:Label ID="categoryLabel" runat="server" Text='<%# Eval("category") %>' />
                    <br />
